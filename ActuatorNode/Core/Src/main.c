...
motorConfig	motor1;
encoderMotor encoderInfo = {.encodeCnt = 0, .position = 0, .preEncoderCnt = 0,
							.prePosition = 0, .speed = 0, .timeIndex = 0, .numRoundPerSec = 0};
PIDInfor pidInfor = {.kp = KP, .ki = KI, .kd = KD, .error = 0, .prevError = 0, .errorIntergral = 0,
		.currT = 0, .prevT = 0, .deltaT = 0, .outputPID = 0, .timeCountPID = 0};
